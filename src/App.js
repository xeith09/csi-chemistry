  ...
  stations: [
    {
      ...
      answer: { accepted: ["Cu2+","Cu²+","copper(II)","Copper(II)","copper(Ⅱ)","Copper(Ⅱ)"], partialCredit: ["Cu+2","Cu 2+","copper II","copper 2+","copper(ii)","copper(iI)","copper(Ii)"] },
...
function PhaseStation({ station, onSolved, caseIdx, detectiveId, theme }) {
  ...
  const tryUnlock = async () => {
    ...
    if(formulaMatch||nameMatch){
      ...
      if(inputLower==="copper"||inputLower==="iron"||inputLower==="manganese") msg="❌ Transition metals need Roman numerals in brackets! e.g. copper → copper(II), iron → iron(II) or iron(III)";
